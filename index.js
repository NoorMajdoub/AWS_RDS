...
tempConnection.query(`CREATE DATABASE IF NOT EXISTS mydatabase `, (err) => {
  if (err) {
  ...
  const db = mysql.createConnection({
    host: process.env.DB_HOST || 'database-2.clxggjjwttbp.us-east-1.rds.amazonaws.com',
    user: process.env.DB_USER || 'admin',
    password: process.env.DB_PASSWORD || 'okmadonna123P',
